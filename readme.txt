...
5. Exemple: <blockquote><a href="#" class="kwm-force-donwload" data-forcedownload="150">Imagem</a><\blockquote>
6. you should use different default permalinks. use eg meusite.com.br/category/post_type
